...
public class AddressUtils {
	...
	public static String getAddresses(String ipAddress) throws UnsupportedEncodingException {
		// 这里调用淘宝API
		String urlStr = "http://freeapi.ipip.net/"+ipAddress;
